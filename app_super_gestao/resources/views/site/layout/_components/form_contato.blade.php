...
<form action="{{ route('site.contato') }}" method="post">
    {{-- o csrf cria um tokem para verificar o formulario, nescessario em metodos post --}}
    @csrf
    ...
    <br>
    <textarea name="mensagem_texto" class="borda-preta">Preencha aqui a sua mensagem</textarea>
    <br>
